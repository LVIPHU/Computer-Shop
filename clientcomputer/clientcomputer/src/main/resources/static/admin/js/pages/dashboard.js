...
var config1 = {
    type: "line",
    data: {
        labels: ["Tháng 1", "Tháng 3", "Tháng 5", "Tháng 7", "Tháng 9", "Tháng 11", "Tháng 12"],
        datasets: [{
            label: "Lượt truy cập ",
            backgroundColor: "#fff",
            borderColor: "#fff",
            data: [2000, 4000, 2000, 7000, 1000, 5000, 2000],
            fill: false,
...
var config2 = {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: "#fff",
            borderColor: "#fff",
            data: [20.000, 800.000, 300.000, 400.000, 10.000, 50.000, 20.000],
            fill: false,
            pointBorderWidth: 100,
            pointBorderColor: "transparent",
            pointRadius: 3,
...
var config4 = {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: "#fff",
            borderColor: "#fff",
            data: [200, 400, 200, 700, 100, 50, 230],
            fill: false,
            pointBorderWidth: 100,
            pointBorderColor: "transparent",
            pointRadius: 3,
